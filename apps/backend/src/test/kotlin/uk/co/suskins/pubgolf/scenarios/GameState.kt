...
class GameState : ScenarioTest() {
    ...
    @Test
    fun `Players have randomise attributes`() {
        val host = "Ben"
        ...
        val randomise = player["randomise"] as Map<*, *>
        assertThat(randomise["hole"], equalTo(2))
        assertThat(randomise["result"] as String, matches(resultPattern))
    }
